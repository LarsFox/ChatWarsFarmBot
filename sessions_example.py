...
Параметры для вызова main.py:
    ...
    -c: (только для одного пользователя) показываем код в запущенном ТГ.
...
ADVENTURES = [
    ...
    {"command": CAVE, "level": 50, "chance": 0.1},
