...
Пока не умеет собирать информацию об оружии самостоятельно,
поэтому после каждого изменения перезапускаем бота с флагом -r.
...
from bot.data import ATTACK, DEFEND, RIGHT, LEFT
